...
import { X, Brain, CheckCircle, AlertTriangle, TrendingUp, Lightbulb, Target, Shield } from 'lucide-react';

function DetailModal({ isOpen, onClose, title, data, fields, aiField, onAiAnalyze, analyzing }) {
                ...
                {onAiAnalyze && (
                  ...
                  >
                    {analyzing ? (
                      ...
                      <>
                        <Brain size={14} />
                        {data[aiField] ? 'Regenerate' : 'Generate Analysis'}
                      </>
                    )}
                  </button>
                )}
